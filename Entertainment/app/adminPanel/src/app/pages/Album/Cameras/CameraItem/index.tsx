    ...
    return (
        <>
            ...
            <ConfirmDialogComponent
                ...
                message={'Are you sure you want to delete this Album? There is no way to undo it if you delete it'}
                                ...
                                <div className={classes.left}>
                                    {
                                        movie?.episodes?.map((episod, index) => (
                                            <div key={index} className={classes.item} id={`${episod.id}`}>
                                                <div >
