namespace EntertainmentApp.Infrastructure.Repository
{
    public class PublicationRepository : IPublicationRepository
    {
        ...
        public async Task<List<Guid>> GetNotExistNewsPapersId(List<Guid> ids)
        {
            var existingIds = await _context.NewsPapers
        ...
        public async Task<List<Guid>> GetNotExistOnSeverNewsPapersId(List<Guid> ids)
        {
            var serverIds = await _context.NewsPapers
                .Select(m => m.Id)
                .ToListAsync();
        ...
        public async Task<List<NewsPaper>> GetNewsPapersNeedToDownloadAsync()
        {
        ...
        public async Task<List<Guid>> GetNotExistMagazinesId(List<Guid> ids)
        {
            var existingIds = await _context.Magazines
                .Where(m => ids.Contains(m.Id))
                .Select(m => m.Id)
                .ToListAsync();
        ...
        public async Task<List<Guid>> GetNotExistOnSeverMagazinesId(List<Guid> ids)
        {
            var serverIds = await _context.Magazines
                .Select(m => m.Id)
                .ToListAsync();
        ...
        public async Task<List<Magazine>> GetMagazinesNeedToDownloadAsync()
        {
            var excludedStatuses = new[]
            {
                DownloadStatus.NotNeed,
