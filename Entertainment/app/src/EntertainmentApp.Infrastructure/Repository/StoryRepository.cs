namespace EntertainmentApp.Infrastructure.Repository
{
    public class StoryRepository : IStoryRepository
    {
        ...
        public async Task<List<Guid>> GetNotExistAudioStoriesId(List<Guid> ids)
        {
            var existingIds = await _context.AudioStories
        ...
        public async Task<List<Guid>> GetNotExistOnSeverAudioStoriesId(List<Guid> ids)
        {
            var serverIds = await _context.AudioStories
                .Select(m => m.Id)
                .ToListAsync();
        ...
        public async Task<List<AudioStoryEpisode>> GetAudioEpisodesNeedToDownloadAsync()
        {
            ...
            return await _context.AudioStoryEpisodes
        ...
        public async Task<AudioStory?> GetAudioStoryByEpisodeIdAsync(Guid episodeId)
        {
            return await _context.AudioStories
                    .Include(se => se.Episodes)
                .FirstOrDefaultAsync(a =>
                        a.Episodes.Any(e => e.Id == episodeId));
        }


        public async Task UpdateEpisodeAsync(AudioStoryEpisode episode)
        {
            _context.AudioStoryEpisodes.Update(episode);
            await _context.SaveChangesAsync();
        }



        public async Task<List<Guid>> GetNotExistBooksId(List<Guid> ids)
        {
        ...
        public async Task<List<Guid>> GetNotExistOnSeverBooksId(List<Guid> ids)
        {
            var serverIds = await _context.Books
                .Select(m => m.Id)
                .ToListAsync();
        ...
        public async Task<List<Book>> GetBooksNeedToDownloadAsync()
        {
            var excludedStatuses = new[]
            {
                DownloadStatus.NotNeed,
        ...
        public async Task<List<AudioStory>> GetAudioStoriesNeedToDownloadAsync()
        {
            var excludedStatuses = new[]
            {
                DownloadStatus.NotNeed,
            ...
            return await _context.AudioStories.Include(s => s.Episodes)
                .Where(x => !excludedStatuses.Contains(x.DownloadStatus))
                //.Select(x => x.Id)
                .ToListAsync();
        }
        public async Task<List<PodCast>> GetPodCastsNeedToDownloadAsync()
        {
            var excludedStatuses = new[]
            {
                DownloadStatus.NotNeed,
            ...
            return await _context.PodCasts.Include(s => s.Episodes)
                .Where(x => !excludedStatuses.Contains(x.DownloadStatus))
                //.Select(x => x.Id)
                .ToListAsync();
        }
        ...
        public async Task<List<Guid>> GetNotExistPodCastsId(List<Guid> ids)
        {
            var existingIds = await _context.PodCasts
                .Where(m => ids.Contains(m.Id))
                .Select(m => m.Id)
                .ToListAsync();
        ...
        public async Task<List<Guid>> GetNotExistOnSeverPodCastsId(List<Guid> ids)
        {
            var serverIds = await _context.PodCasts
                .Select(m => m.Id)
                .ToListAsync();
        ...
        public async Task<List<PodCastEpisode>> GetPodCastEpisodesNeedToDownloadAsync()
        {
            var excludedStatuses = new[]
            {
                DownloadStatus.NotNeed,
        ...
        public async Task<PodCast?> GetPodCastByEpisodeIdAsync(Guid episodeId)
        {
            return await _context.PodCasts
                    .Include(se => se.Episodes)
                .FirstOrDefaultAsync(a =>
