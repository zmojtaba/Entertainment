...
using EntertainmentApp.Application.Features.CoruFeature;
using EntertainmentApp.Application.Features.Music.AlbumFeature;
using EntertainmentApp.Application.Features.Music.TrackFeatur;
using EntertainmentApp.Application.Features.Publication.NewsPaperFeature;
using EntertainmentApp.Application.Features.Story.AudioStoryFeature;
using EntertainmentApp.Application.Features.Story.BookFeature;
using EntertainmentApp.Application.Features.Story.PodCastFeature;
using EntertainmentApp.Application.Features.Video.MoviesFeature;
using EntertainmentApp.Application.Features.Video.SeriesFeature;

namespace EntertainmentApp.Application.Behaviors
{
