...
namespace EntertainmentApp.Application.Interfaces
{
    public interface IPublicationRepository
    {
        ...
        public Task<List<Guid>> GetNotExistNewsPapersId(List<Guid> ids);
        public Task<List<Guid>> GetNotExistOnSeverNewsPapersId(List<Guid> ids);
        public Task<List<NewsPaper>> GetNewsPapersNeedToDownloadAsync();
        public Task<List<Guid>> GetNotExistMagazinesId(List<Guid> ids);
        public Task<List<Guid>> GetNotExistOnSeverMagazinesId(List<Guid> ids);
        public Task<List<Magazine>> GetMagazinesNeedToDownloadAsync();
