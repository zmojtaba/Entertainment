...
namespace EntertainmentApp.Application.Interfaces.Video
{
    public interface IMovieRepository
    {
        ...
        public Task<List<Guid>> GetNotExistMoviesId(List<Guid> ids);
        public Task<List<Guid>> GetNotExistOnSeverMoviesId(List<Guid> ids);
        public Task<List<Movie>> GetMoviesNeedToDownloadAsync();
