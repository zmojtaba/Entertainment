namespace EntertainmentApp.Application.Features.Video.MoviesFeature
{
    ...
    public class CreateMovieHandler: ICommandHandler<CreateMovieCommand, Movie>
    {

        private readonly IMovieRepository _movieRepo;
        private readonly IMediaService _mediaService;
        public CreateMovieHandler(IMovieRepository movieRepo, IMediaService mediaService)
        {
