...
namespace EntertainmentApp.Application.Features.Video.SeriesFeature
{
    ...
    public class DeleteEpisodeHandler(ISeriesRepository seriesRepo, IMediaService mediaService) : ICommandHandler<DeleteEpisodeCommand, string>
    {
        public async Task<string> Handle(DeleteEpisodeCommand request, CancellationToken cancellationToken)
        {
            ...
            await seriesRepo.DeleteEpisodeAsync(episode);
