...
using Entertainment.Server.Applicatoin.Interfaces.CoruRepository;
using Entertainment.Server.Infrastructure.Repository;

namespace Entertainment.Server.Infrastructure
{
