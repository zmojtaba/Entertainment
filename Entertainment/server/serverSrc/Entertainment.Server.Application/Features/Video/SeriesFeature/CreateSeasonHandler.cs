namespace Entertainment.Server.Applicatoin.Features.Video.SeriesFeature
{
    ...
    public class CreateSeasonHandler : ICommandHandler<CreateSeasonCommand, SeasonDto>
    {
        private readonly ISeriesRepository _seriesRepository;
        private readonly IMediaService _mediaService;
        public CreateSeasonHandler(ISeriesRepository seriesRepository, IMediaService mediaService)
        {
