namespace Entertainment.Server.API.Controllers
{
    ...
    public class StoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddPodcastAsync([FromForm] AddPodCastDto dto)
        {
            ...
            AddPodCastCommand command = new AddPodCastCommand
            {
                Title = dto.Title,
        ...
        {
            List<PodCastDto> result = await _mediator.Send(new GetPodCastsQuery(language, genre));
            return Ok(result);
        }
        ...
        {
            List<AudioStoryDto> result = await _mediator.Send(new GetAudioStoriesQuery(language, genre));
            return Ok(result);
        }
