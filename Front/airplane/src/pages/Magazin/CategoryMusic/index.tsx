...
import { categoreyMagazin } from '../constant/utils';
import type { CategoryMagazin } from '../types';
            ...
            <div className={classes.main}>
                ...
                >
                    {categories.map((item, index) => {
                        return (
                            <motion.div
                                onClick={() => navigate(`/${item.type.includes('Magazine')?'Magazine':'Newspaper'}/${item.type}`)}
...
export default CategoryMagzinPage