...
export default function Slider() {
    ...
    const [movies, setMovies] = useState<IBook[]>([]);
                    ...
                    <div className={classes.sliderTrack} ref={sliderRef}>
                        {movies.map((m, idx) => (
                            <div
                                ...
                                onClick={() => navigate(`/Book/${category}/${m.id}`)}
                            >
                                ...
                                <div className={classes.movieHover}>
                                    ...
                                    <div className={classes.desc}>{`writers : ${m.writers.map(w=>w.name)} `}</div>
                                    {/* <button className={classes.playBtn}>Show Book</button> */}
                                </div>
                            </div>
                        ))}
                    </div>
