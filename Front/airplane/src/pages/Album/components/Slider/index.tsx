...
export default function Slider() {
    ...
    const [movies, setMovies] = useState<IAlbum[]>([]);
    const [selectedGenre, setSelectedGenre] = useState('');
    const [loading, setLoading] = useState(false)
    const navigate = useNavigate()
    const { category } = useParams();

    // console.log("ffffff",category == 'Iranian_Album');

    useEffect(() => {
        let tempLanguage = '';
        if (category == 'Iranian_Album') {
                    ...
                    <div className={classes.sliderTrack} ref={sliderRef}>
                        {movies.map((m, idx) => (
                            <div
                                ...
                                onClick={() => navigate(`/Music/Album/${category}/${m.id}`)}
                            >
                                ...
                                <div className={classes.movieHover}>
                                    ...
                                    <div className={classes.desc}>{m.singer?.name}</div>
