...
export default function Slider() {
    ...
    const handleFilterByGeners = (title: string) => {
                    ...
                    <div className={classes.sliderTrack} ref={sliderRef}>
                        {movies.map((m, idx) => (
                            <div
                                ...
                                onClick={() => navigate(`/Music/${category}/${m.id}`)}
                            >
                                ...
                                <div className={classes.movieHover}>
                                    ...
                                    <div className={classes.desc}>{`Singer : ${m.singer.name}`}</div>
