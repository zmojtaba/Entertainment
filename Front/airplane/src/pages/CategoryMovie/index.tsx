...
import type { CategoryMovie } from '../../store/types';
import { categoreyMovies } from '../../constants/utilis';
...
function CategoryMoviePage() {
    ...
    const [categories, setCategories] = useState<CategoryMovie[]>([])
    const navigate = useNavigate()

    useEffect(() => {
        setCategories(categoreyMovies)
    }, [])
            ...
            <div className={classes.main}>
                ...
                >
                    {categories.map((item, index) => {
                        return (
                            <motion.div
                                onClick={() => navigate(`/Movies_&_series/${item.type}`)}
