...
import LoadingComponets from './Components/Loading/index.js'
...
import CategoryNewsPaperPage from './pages/Magazin/CategoryMusic/index.js'
...
import Player from './pages/Movies/pages/Film/index.js'
...
function App() {
  ...
  return (
    <div className={classes.mainPage}>
      ...
      <LoadingComponets loading={false} />
    </div>
  )
}
