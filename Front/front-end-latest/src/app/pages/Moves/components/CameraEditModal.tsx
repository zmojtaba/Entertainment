...
function MovieEditModal() {
    ...
    console.log('movieRefrenceData : ', movieRefrenceData)
    ...
    const handleChangeAge: ChangeEventHandler<HTMLInputElement> = (e) => {
        ...
        if (!value) {
            ...
            setMovie({ ...movie, ageGroup: '' });
            return;
        }

        // فقط اعداد (بدون حرف، علامت، نقطه و ...)
        if (!/^\d+$/.test(value)) {
            setErrors({ ...errors, age: 'error' });
            return;
        }
    ...
    const handleSaveCamera = () => {
        ...
        if (selectedSubtitle == null && !editID) {
            temErrors.subtitle = 'select subtitle'
        }
        ...
        if (!isError) {
            if (!editID) {
                setLoading(true)
                uploadVideo(movie, selectedVideo!, selectedPoster!, selectedSubtitle!, (progress) => {
                                                    ...
                                                    <div className={classes.showFile} >
                                                        <div className={classes.file}>
                                                            ...
                                                            <div className={classes.fileInfo}>
                                                                ...
                                                                <span>{`${formatBytes(selectedSubtitle.size)}`}</span>
                                                            </div>
                                                        </div>
