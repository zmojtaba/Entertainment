...
import { RouteItem } from "app/app-configs/routesConfig"
...
class AppUtils {
  ...
  static setRoutes(config, defaultAuth): RouteItem[] {
  ...
  static difference(object, base) {
    function changes(_object, _base) {
      return _.transform(_object, (result: any, value, key) => {
