...
import { DataRefrence, IGenersItem, ISeasons, ISeries } from "../store/type";
...
export const updateVideo = (movie: ISeries, file: File) => {
    ...
    let mapped = {
        ...
        languages: movie?.language?.map(m => m),
...
export const uploadVideoSeries = (file: File, series: ISeries, onProgress) => {
...
export const AddEpisoda = (file: File, series: ISeries, season: ISeasons, onProgress) => {
