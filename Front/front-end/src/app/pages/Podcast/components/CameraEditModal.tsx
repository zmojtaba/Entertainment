...
function MovieEditModal() {
    ...
    // console.log('currentError ', movieRefrenceData)
    ...
    return (
        ...
        >
            ...
            <DialogTitle sx={{ display: 'flex', alignItems: 'center', py: .5, pr: 1, fontSize: '1.4rem' }}>
                <p>
                    {editID ? 'Edit Podcast' : t('New Podcast')}
                </p>
                {editID &&
                                    ...
                                    <Stack spacing={3}
                                        ...
                                        <Stack spacing={0.5} >
                                            ...
                                            <Autocomplete
                                                multiple
                                                freeSolo
                                                options={movieRefrenceData?.genres.map(g => g.title)! ?? []}       // عمداً خالی
                                                value={movie?.genres.map(b => b.title) || []}
                                            ...
                                            <Autocomplete
                                                ...
                                                renderInput={(params) => (
                                                    <TextField
                                                        ...
                                                        size="small"
                                                        placeholder="Type name speaker,Enter"
                                                    />
                                                )}
                                            />
