...
import { selectFlatNavigation } from "app/store/core/navigationSlice"
      ...
      {variant === "basic" ? (
        ...
        <>
          <TextField
            ...
            InputProps={{
              ...
              classes: {
                input:
                  "Search-input py-0 px-2 h-5 md:h-48 ltr:pr-6 rtl:pl-6",
                notchedOutline: "rounded-0.5"
              }
            }}
            variant="outlined"
            {...other}
          />
          <Icon
            className="absolute top-0 ltr:right-0 rtl:left-0 h-5 md:h-48 w-48 p-1.5 pointer-events-none"
            color="action"
          >
            search
          </Icon>
        ...
        <TextField
          ...
          InputProps={{
            ...
            classes: {
              input: "Search-input py-0 px-2 h-6 md:h-8"
            }
          }}
          variant="standard"
          {...other}
    ...
    <MenuItem selected={isHighlighted} component="div">
      <ListItemIcon className="min-w-5">
        {suggestion.icon ? (
          ...
          <span className="text-20 w-24 font-600 uppercase text-center">
            {suggestion.title[0]}
          </span>
        )}
      </ListItemIcon>
            ...
            renderSuggestionsContainer={(options) => (
              ...
              >
                <div ref={suggestionsNode}>
                  <Paper
                    className="shadow-lg rounded-0.5 overflow-hidden"
                  ...
                  >
                    {options.children}
                    {state.noSuggestions && (
                      <Typography className="px-2 py-1.5">
                        {props.noResults}
                      </Typography>
                    )}
                  </Paper>
...
Search.defaultProps = {
  trigger: (
    <IconButton className="w-5 h-5" size="large">
      <Icon>search</Icon>
    </IconButton>
  ),
  variant: "full",
