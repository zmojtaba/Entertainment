    ...
    <Root>
      <Hidden lgDown>
        <Paper
          ...
          square
        >
          <Scrollbars className={clsx("content", "AppSidePanel-content")}>
            {props.children}
          </Scrollbars>
          ...
          <div className="FuseSidePanel-buttonWrapper">
            ...
            >
              <IconButton
                ...
                size="large"
              >
                <Icon className="FuseSidePanel-buttonIcon">
                  keyboard_arrow_left
                </Icon>
              </IconButton>
            </Tooltip>
      ...
      <Hidden lgUp>
        <SwipeableDrawer
          classes={{
            paper: clsx("AppSidePanel-paper", props.className)
          }}
        ...
        >
          <Fab
            className={clsx("AppSidePanel-mobileButton", props.position)}
