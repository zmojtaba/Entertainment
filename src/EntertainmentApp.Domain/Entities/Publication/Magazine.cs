...
namespace EntertainmentApp.Domain.Entities.Publication
{
    public class Magazine : BaseEntity
    {
        ...
        public long PublishedDate { get; private set; } = default;
        ...
        public Magazine(string title, List<string> languages, long publishedDate, string streamUrl, string posterImageUrl)
        {
            SetTitle(title);
