...
{
    public class UpdateAudioStoryHandler
    {
        ...
        public class AddAudioStoryCommandValidator : AbstractValidator<UpdateAudioStoryCommand>
        {
        ...
        public class UpdatePodCastCommandHandler(IStoryRepository storyRepo, IMediaService mediaService) : ICommandHandler<UpdateAudioStoryCommand, AudioStoryDto>
        {
